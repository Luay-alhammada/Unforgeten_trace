...
<li><strong>الفئة الثانية:</strong> تضم المحققين الذين ذُكرت أسماؤهم الأولى أو الكاملة. في بعض الحالات، أشارت السجلات إلى القسم أو اللجنة المسؤولة عن التحقيق بدلًا من اسم المحقق. .</li>
</ul>
...
يوضح الرسم البياني أعلاه أكثر 15 موقعًا ورودًا، مثل <b>المزة الجديد</b> و<b>المزة </b>. 
...
""", unsafe_allow_html=True)
#-----------------------------------------------
share_url = "https://unforgetentrace-lvsebpbxlivulgb37f92nc.streamlit.app/"  # 👈 ضع رابط تطبيقك بعد النشر
